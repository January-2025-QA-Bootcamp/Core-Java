...
// here public is called "access modifier", class --> what you created here, HelloWorld --> is the name of the class
...
public class HelloWorld {
	...
	public static void main(String[] args) {
		...
		// we forgot or sometime we delete the semicolon
		// we delete curly braces at the end
	}
}

// This part is called Editor, where we write code
