...
// No need to give a space after \n or \t, it will give you an extra space
...
public class F_michael_gordan {
	public static void main(String[] args) {
		System.out.println("Michael Jordan, Born in 1987, American actor (Black Panther), in Santa Ana, California");
		System.out.println("\n-------------------------------------------------------------");
