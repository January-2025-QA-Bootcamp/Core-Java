...
public class MyInfo {
	...
	// variable name starts with lower case and follow camel case feature or snake
	// case pattern
	// variables can be either declared (no value assigned) or initialized (value
	// assigned)
	...
	// char [it's from character] is the type of the variable,
	// "myGender" is the name of the char type variable
	// char type values are always inside single quotation and best practice to use
	// in upper case
	public char myGender = 'M';

	// boolean is the type of the variable,
	// "usCitizen" is the name of the boolean type variable
	// boolean type values are with no quotation. Represented by true or false [in
	// lower case only]
	...
	// float type values are written with no quotation
	...
	public static void main(String[] args) {
		...
		// MyInfo (blue color) is a class, tofael (yellow color) is an object, also
		...
		// an object is created (tofael) (by you) from 'MyInfo' class (following
		// blueprint) which (object) is new and MyInfo type
		// This action (line 56) --> (when an object is created from a class) is called
		// "instantiation", (vvImp info, memorize it)
		...
		// what object do?
		// Ans: object can call the properties [variables, constructor, method] of the class [from where it is created]
		...
		// We can call 2 or more variable at the same time by + symbol
		System.out.println(tofael.myName + tofael.myYearlySalary);

		// you can use String inside it
		System.out.println("My Name: " + tofael.myName);
		...
		System.out.println("My Name: " + tofael.myName + ", My Yearly Salary: " + tofael.myYearlySalary
				+ ", My Gender: " + tofael.myGender + ", My Citizenship: " + tofael.usCitizen + ", My Height: "
				+ tofael.myHeight);
		
		// A class can create more than one object
		MyInfo rahi = new MyInfo();
		System.out.println(rahi.myName);
